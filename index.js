...
const ftpServer = new FtpSrv({
  ...
  anonymous: true, // Allow anonymous login (can be changed to false for authentication)
    ...
    put: async (dataStream, filePath) => {
      try {
        ...
        if (path.extname(filePath).toLowerCase() === '.json') {
          ...
          console.log('CSV file detected. You may need to implement CSV parsing.');
        }
...
ftpServer.on('login', ({ connection, username, password }, resolve, reject) => {
  ...
  // If you want to implement authentication, you can check credentials here
  // For now, we're allowing anonymous access
